...
public class Analyzer {
    ...
    public LinkedHashMap<String, HashSet> getTable(InputStream inputStream) {
        HashSet<String> colSet = null;
        LinkedHashMap<String, HashSet> grouped = new LinkedHashMap<String, HashSet>();
    ...
    private boolean isTableEnd(String line){ return isMatch(Patterns.TABLE_END, line); }
